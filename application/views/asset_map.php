...
<body>
	...
	<script>
		...
		function drawMarkers(){
			...
			$.ajax({
				url: "<?=base_url("index.php/ads/get_asset_data") ?>",
				method: "POST",
				cache: false,
				statusCode: {
					200: function(json){
...
//				console.log("markers removed");
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCMJAxjDMr91aIbzuqhdeJ8tnmnx6MqTb4&callback=initMap"
    ></script>
