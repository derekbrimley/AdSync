...
Ad Requests
<span>
	<button id="refresh_ads_btn" onClick="refresh_ad_spots()" type="button" style="position:relative;bottom:4px;left:400px;padding:8px;cursor:pointer;color:white;background-color:#0079C1;border:0px;font-size:16px;">Refresh Ads</button>
